...
namespace _1CommonInfrastructure.Services
{
    public class LoggingService : ILoggingService
    {
        ...
        {
            var connectionString = "data source=.\\sqlexpress;initial catalog=test_8Nov2022;integrated security=True;MultipleActiveResultSets=True;TrustServerCertificate=True;";//_configuration.GetSection("ConnectionStrings:ApplicationDB");                    
